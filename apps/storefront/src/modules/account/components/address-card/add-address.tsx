...
const AddAddress = ({
  ...
  return (
    <>
      <button
        className="border border-dashed border-[var(--theme-border)] p-6 min-h-[200px] flex flex-col items-center justify-center gap-3 w-full text-[var(--theme-text-muted)] hover:border-hunter-gold hover:text-hunter-gold transition-colors group"
        onClick={open}
      ...
      <Modal isOpen={state} close={close} data-testid="add-address-modal">
        <Modal.Title>
          <span className="font-display text-[22px] leading-[1]">Add address</span>
        </Modal.Title>
        <form action={formAction}>
          <Modal.Body>
            <div className="flex flex-col gap-y-2 w-full">
              ...
              <Input label="Address" name="address_1" required autoComplete="address-line1" data-testid="address-1-input" />
              <Input label="Apartment, suite, etc." name="address_2" autoComplete="address-line2" data-testid="address-2-input" />
              <div className="grid grid-cols-[144px_1fr] gap-x-2">
                <Input label="Postal code" name="postal_code" required autoComplete="postal-code" data-testid="postal-code-input" />
            ...
            {formState.error && (
              <p className="font-sans text-[10px] text-rose-500 mt-2" data-testid="address-error">
                {formState.error}
              </p>
            )}
          </Modal.Body>
