              ...
              <Dialog.Panel
                ...
                className={clx(
                  "flex flex-col justify-start w-full transform p-5 text-left align-middle transition-all max-h-[75vh] h-fit",
                  {
                    ...
                    "bg-[var(--theme-bg)] shadow-2xl border border-[var(--theme-border)]": !search,
                  }
                )}
              >
  ...
  return (
    <Dialog.Title className="flex items-center justify-between mb-5 pb-5 border-b border-[var(--theme-border)]">
      ...
      <button
        ...
        className="inline-flex h-8 w-8 items-center justify-center text-[var(--theme-text-muted)] hover:text-[var(--theme-text)] transition-colors"
      >
        <X size={16} />
      </button>
    </Dialog.Title>
