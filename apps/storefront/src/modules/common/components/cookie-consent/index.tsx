      ...
      {shouldRender && (
        ...
        >
          <CookieConsentBanner
            ...
            onDecline={reject}
            buttonText="Accept"
            declineButtonText="Doar necesare"
            disableStyles
            ...
            ariaAcceptLabel="Accept toate cookies"
            ariaDeclineLabel="Doar cookies necesare"
          >
            Acest site folosește cookies pentru a analiza traficul și a-ți
            oferi o experiență de navigare cât mai plăcută.{" "}
            <Link
              href="/cookie-policy"
