...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  // Session ids are generated by us at initiatePayment; reject anything that
  // is not shaped like one before it reaches the query layer.
  if (!sessionId || !/^(ps|sess)_[A-Za-z0-9_-]{1,64}$/.test(sessionId)) {
