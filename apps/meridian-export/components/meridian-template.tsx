...
export default function MeridianTemplate() {
  return (
    <div className="thm-root">
      <HashScrollFix />
      <SiteHeader homeHref="/" showMeridianSuffix />
      <div className="thm-hero-shell">
        ...
        <section
          ...
          style={{
            ...
            // Pull up under the transparent sticky header so the hero image
            // shows through behind it, with extra top padding to compensate
            // so content still clears it.
            marginTop: "-4rem",
            padding:
            ...
            >
             <div className="thm-hero-top-group">
              ...
              >
                ...
                , într-o singură zi, la Piața Cetății în Baia Mare.
              </p>
             </div>
              <div
        ...
        <Reveal>
          <div style={{ maxWidth: 1360, margin: "0 auto" }}>
            <div style={{ maxWidth: 640 }}>
              <div style={eyebrowRow}>
                <EyebrowLine style={eyebrowRule} />
                <span style={eyebrowLabel}>Zona VIP</span>
              </div>
              ...
              >
                Un spațiu privat, dedicat unui număr limitat de invitați.
              </p>
              <div
                style={{
                  display: "flex",
      ...
      <section id="locatia" style={{ background: "var(--dark)" }}>
        ...
        >
          <iframe
            ...
            title="Hartă Google, Piața Cetății, Baia Mare"
            loading="lazy"
